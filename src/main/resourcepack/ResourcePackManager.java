...
public class ResourcePackManager {
    ...
    private void generateNoteBlockState(List<NexoBlock> blocks, File blockstatesFolder,
        ...
        for (NexoBlock block : blocks) {
            ...
            int instrIdx = block.getBlockData() / 25;
            int note = block.getBlockData() % 25;
    ...
    public void sendPackToPlayer(Player player) {
        ...
        try {
            if (packSha1 != null) {
                player.setResourcePack(packUrl, packSha1, required, net.kyori.adventure.text.Component.text(
                        plugin.getConfigManager().getPackPromptMessage()));
            } else {
